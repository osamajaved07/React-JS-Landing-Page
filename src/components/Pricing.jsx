...
const Pricing = () => {
  return (
    <div id="pricing" className="mt-20">
      <motion.h2 className="text-3xl sm:text-5xl lg:text-6xl text-center my-8 tracking-wide" initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: false }}>
        Pricing
      </motion.h2>
